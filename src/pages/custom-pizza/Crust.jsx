...
const Crust = () => {
    const data = [
        { name: "Original", image: "https://images.unsplash.com/photo-1573821663912-569905455b1c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" },
    ...
    const [crusts, setCrusts] = useState(data);
    const [next, setNext] = useState(`/size`);
